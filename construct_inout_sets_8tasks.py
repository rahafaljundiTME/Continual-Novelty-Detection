...
"""
Construct the 3 In Out Forg. Sets for the 8-task sequcne
"""
def construct_out(model_path, dataset_path, batch_size=300,task_index=0,pre_num_classes=0):
    """
...
def construct_train_in(model_path, dataset_path, batch_size=300,task_index=0,pre_num_classes=0):
    """
