...
"""
Evaluate CND performance on TinyImageNet split
"""
...
parser.add_argument('--novelty_method', choices=['ODIN', 'Max_Softmax','Mahalanobis','Gen_based','Energy','Open_Sim','Open_Sim_perturb','Open_Stat','Baseline','CND_ClP','CND_P','CND_ENT'], default='ODIN', help='which novelty detection to use')
